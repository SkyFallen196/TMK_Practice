...
![](https://cdn.mathpix.com/cropped/2024_07_11_7c83543e1550434c4e02g-2.jpg?height=44&width=1519&top_left_y=248&top_left_x=180)
...
| Марка стали | Временное <br> сопротивление <br> разрыву $\sigma_{\mathrm{s}}$, МПа | Предел текучести <br> $\sigma_{\mathrm{r}}$, МПа <br> (кгс $\left./ \mathbf{M M}^{2}\right)$ | Относительное <br> удлинение $\delta_{s}$, % | Твердость по Бринеллю (при <br> толщине стенки более 10 мм) |  |
| :---: | :---: | :---: | :---: | :---: | :---: |
|  | не менее |  |  | Диаметр отпечатка, мм, не | Число твердости <br> НВ, не более |
...
$60^{\circ}$ - для труб из стали марок 20, Ст4сп, 15 XM .
...
3.9. Гидравлическое испытание труб проводят по ГОСТ 3845 с выдержкой под давлением не менее 10 c .
...
Технический редактор О. Н. Власова Корректор А. С. Черноусова
